...
<div id="legend">
  ...
  <div id="classification-1">
    <h2>Waterways</h2>
    <div class="legend-contents" onmouseover="updateLegend(event, 'waterwaylegend.png', 'Waterways')" onmouseout="resetLegend(event)">
      <img src="../img/waterwaylegend.png" alt="">
      <p>Waterways</p>
    </div>
    <div class="legend-contents" onmouseover="updateLegend(event, 'volcstream.png', 'Volcanic Stream')" onmouseout="resetLegend(event)">
      <img src="../img/volcstream.png" alt="">
      <p>Volcanic Stream</p>
    </div>
    <div class="legend-contents" onmouseover="updateLegend(event, 'degraded.png', 'Degraded Waterways')" onmouseout="resetLegend(event)">
      <img src="../img/degraded.png" alt="">
      <p>Degraded Waterways</p>
    </div>
    <div class="legend-contents" onmouseover="updateLegend(event, 'effluentflowlegend.png', 'Discharge Path')" onmouseout="resetLegend(event)">
      <img src="../img/effluentflowlegend.png" alt="">
      <p>Discharge Path</p>
    </div>
  </div>
